...
TypeSliderStyle::TypeSliderStyle()
{
    sliderImage = ImageCache::getFromMemory(BinaryData::typeslider_png, BinaryData::typeslider_pngSize);
}
...
void TypeSliderStyle::drawRotarySlider(Graphics& g,
